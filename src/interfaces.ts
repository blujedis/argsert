...
export type ArgsertErrorHandler = (err: string | Error, result?: IArgsertResult) => void;
export type ArgsertTypeHandler = (val: any, index?: number, result?: IArgsertResult) => string;
export type ArgsertStripHandler = RegExp | { (val: any): string };
export type ArgsertExpandHandler = RegExp | { (val: string): string[] };
export type ArgsertValidator = (result: IArgsertResult) => string | Error | IArgsertValidatorResult;
...
export interface IArgsertOptions {
  ...
  validators?: { [key: string]: IArgsertValidator; };
  strict?: boolean;
  templates?: {
    unmet?: string;
    extra?: string;
